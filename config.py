# Don't Remove Credit Tg - @Shareef_insaaan
# Ask Doubt on telegram @Shareef_insaaan
...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6875229283:AAH9D75NeOac7AKS6DVEGHpd1oB2tDoi2lY")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "URL_uploader_xx_bot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "22012880"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "5b0e07f5a96d48b704eb9850d274fe1d")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "2031106491")) 
    TECH_VJ_SESSION_NAME = "URL_uploader_xx_bot"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://sparklingmind42:<5gIXMTGulGFQkhDv>@cluster0.ckmwyed.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002189435447")) # your log channel id and make bot admin in log channel with full right 
